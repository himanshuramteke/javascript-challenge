...
// Test cases
let testCases = [
    { beginWord: "hit", endWord: "cog", wordList: ["hot","dot","dog","lot","log","cog"] }, // Expected output: 5
    { beginWord: "hit", endWord: "cog", wordList: ["hot","dot","dog","lot","log"] }, // Expected output: 0
    { beginWord: "a", endWord: "c", wordList: ["a", "b", "c"] }, // Expected output: 2
    { beginWord: "game", endWord: "thee", wordList: ["game","came","cane","lane","late","date","dare","dare","bare","bore","boar","boar","hoar","hear","heir","herd","here","here","tree","free","thee"] }, // Expected output: 12
];

testCases.forEach((test, index) => {
    const { beginWord, endWord, wordList } = test;
    console.log(`Test Case ${index + 1}: Length of shortest transformation sequence is ${ladderLength(beginWord, endWord, wordList)}`);
});
