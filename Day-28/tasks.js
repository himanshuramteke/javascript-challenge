...
//Activity-1[Seting up the project]
...
//Task-6:Create a shopping cart section that displays the products added to the cart, including the name, price and quantity.Update the cart display whenever a product id added.


//Activity-4[Cart Management]
//Task-7:Add a functionality to update the quantity of products in the cart.Write a function to handle increasing and decreasing the quantity of items.
