...
//Task-1:Initialize the new project directory and set up the basic HTML structure for the movie search app.
...
//Task-3:Use the 'fetch' API to get movie data from a public movie API(e.g.,OMDB API or The Movie Database API).Log the reponse data to the console.
...
//Task-9:Add a CSS style to improve the layout and design of the search results and detailed movie information.
//Task-10:Add a CSS animations or transitions to make the movie search app more interactive and visually appealing.
