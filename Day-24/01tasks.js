...
//Task-1:Initialize the new project directory and set up the basic HTML structure for the weather app.
...
//Task-6:Write a function to fetch and display weather data for a city entered in the search input field. Log the errors to the console.
...
//Task-9:Add the icons or images to represent different weather conditions(e.g.,sunny,rainy,cloudy) based on the weather data.
