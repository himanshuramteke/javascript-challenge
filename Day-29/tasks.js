...
//Task-5:Add a form to the HTML strcuture with fields for entering post details(e.g.,text, image).Style the form using CSS.
//Task-6:Write a script to handle form submission, cerating a new post object and adding it to an array of posts.Display the new post in the feed.
...
//Task-9:Add a "Like" and "Comment" buttons to each post.Write functions to handle liking a post and adding comments to a post.
//Task-10:Display the number of likes and comments for each post.Update the display when uers interact with the posts.

//Activity-6[Enhancing the UI]
//Task-11:Add a CSS styles to differentiate posts by different users.Display the logged-in user's posts with a distinct style.
//Task-12:Add a CSS animations or transitions to make the social media dashboard more interactive and visually appealing.
